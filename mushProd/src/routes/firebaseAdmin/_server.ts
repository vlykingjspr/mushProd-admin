...
// const serviceAccount: ServiceAccount = require('./betapeak-1b551-firebase-adminsdk-ns0d3-3f611f58e0.json') as ServiceAccount;
...
//             body: body,
//         },
//         topic: 'Temperature and Humidity Alert' // or use 'token' for specific devices
//     };
